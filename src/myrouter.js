...
const User = () =>
    import ( /* webpackChunkName: 'user_group' */ '@/components/User.vue') //es提案的import() 把组件按组分块
const UserChildren = () =>
    import ( /* webpackChunkName: 'user_group' */ '@/components/UserChildren.vue') //es提案的import() 把组件按组分块
const C404 = () =>
    import ( /* webpackChunkName: 'C404_group' */ '@/components/404.vue')
const HelloWorld = () =>
    import ( /* webpackChunkName: 'Hello_group' */ '@/components/HelloWorld.vue')
